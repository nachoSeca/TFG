    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div>
                    <a href="{{ route('courses.create') }}" class="form-btn">Añadir curso</a>
                </div>
            </div>
        </div>
        <br>
                ...
                <table class="table table-striped" id="myTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($courses as $course)
                            <tr>
                                <td class="fw-bold">{{ $course->nombre }}</td>
                                <td>
                                    <a href="{{ route('courses.edit', $course->id) }}" class="btn">
                                        <img src="image/edit.png" alt="" class="icons">
                                    </a>
                                    <form action="{{ route('courses.delete', $course) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('GET')
