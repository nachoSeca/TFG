            ...
            <div class="col-md-6 offset-md-3">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-container">
                        ...
                        <form class="form">
                            <input type="email" class="input mb-3" placeholder="Email" id="email">
                            <input type="password" class="input mb-3" placeholder="Password" id="pass">

                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" onclick="mostrarPass()"
                                    id="check">
                            ...
                            <button class="form-btn" onclick="comprobarEmailYPass()">Log in</button>
                        </form>
