                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <input value="{{ old('nota_media') }}" type="number" name="nota_media" class="form-control"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <select name="company_id" id="company_id" class="form-control">
                                <option value="">Seleccionar...</option> <!-- Opción vacía para "selección" -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <input value="{{ old('subir_cv')}}" type="file" name="subir_cv" class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <input value="{{ old('direccion_practicas') }}" type="text" name="direccion_practicas"
                                class="form-control" placeholder="Dirección prácticas">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            <label for="tutor_id"><strong>Tutor:</strong><span class="required">*</span></label>
